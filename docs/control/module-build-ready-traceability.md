...
| brain/affect.py | partial | present | partial | missing | present | missing | partial | HOLD |
...
| brain/circadian.py | partial | present | partial | present | present | missing | partial | HOLD |
...
| brain/executive.py | partial | present | partial | partial | present | missing | partial | HOLD |
...
| brain/hedonic.py | partial | present | partial | missing | present | missing | partial | HOLD |
...
| brain/perception.py | partial | present | partial | missing | present | missing | partial | HOLD |
...
| brain/theory_of_mind.py | partial | present | partial | partial | present | missing | partial | HOLD |
