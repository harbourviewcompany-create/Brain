...
| brain/developmental/consolidation.py | partial | partial | partial | missing | present | present | missing | HOLD |
| brain/developmental/global_workspace.py | partial | partial | partial | missing | present | present | missing | HOLD |
| brain/developmental/immune.py | partial | partial | partial | missing | present | present | missing | HOLD |
| brain/developmental/module_genesis.py | partial | partial | partial | missing | present | present | missing | HOLD |
| brain/developmental/plasticity.py | partial | partial | partial | missing | present | present | missing | HOLD |
| brain/developmental/prediction_error.py | partial | partial | partial | missing | present | present | missing | HOLD |
| brain/developmental/self_model.py | partial | partial | partial | missing | present | present | missing | HOLD |
| brain/developmental/theory_registry.py | partial | partial | partial | missing | present | present | missing | HOLD |
